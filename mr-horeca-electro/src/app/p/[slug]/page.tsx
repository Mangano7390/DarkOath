  ...
  return (
    <div className="container py-10 space-y-8">
      <nav className="flex items-center text-sm text-muted-foreground gap-1">
        ...
        <Link href={isHoreca ? "/horeca" : "/electro"} className="hover:text-foreground">
          {isHoreca ? "HoReCa" : "Electro"}
        </Link>
        {product.category ? (
          <>
            <ChevronRight className="h-3 w-3" />
      ...
      <div className="grid lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-5">
          <div className="flex items-start justify-between gap-3">
            ...
            <Badge variant={isHoreca ? "horeca" : "electro"}>{isHoreca ? "Pro" : "Particulier"}</Badge>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 pt-2 text-xs">
            <div className="flex items-start gap-2">
              <Truck className="h-4 w-4 text-horeca mt-0.5" />
              <div>
            ...
            <div className="flex items-start gap-2">
              <ShieldCheck className="h-4 w-4 text-horeca mt-0.5" />
              <div>
            ...
            <div className="flex items-start gap-2">
              <RotateCcw className="h-4 w-4 text-horeca mt-0.5" />
              <div>
